                ...
                data = data.filter(row => {
                    for (const f of this._filter) {
                        if ("op" in f) {
                            switch (f.op) {
                                case "equal":
                                    if (!(f.field in row && isEqual(row[f.field],f.value))) {
                                        return false;
                                    }
                                    break;
                                case "inequal":
                                    ...
                                    break;
                                case "greater":
                                    if (!(f.field in row && isGreater(row[f.field], f.value))) {
                                        return false;
                                    }
                                    break;
                                case "less":
                                    ...
                                    break;
                                case "greaterthan":
                                    if (!(f.field in row && isGreaterthan(row[f.field], f.value))) {
                                        return false;
                                    }
                                    break;
                                case "lessthan":
...
function isEqual(value1, value2) {
    // 判断是否为日期
    const isDate = (value) => !isNaN(new Date(value).getTime());
